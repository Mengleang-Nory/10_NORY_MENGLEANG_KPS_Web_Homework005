...
const SidebarComponent = () => {
  ...
  return (
    <aside className="w-[414px] flex flex-col p-[20px] bg-white fixed top-0 left-0 bottom-0 z-50">
      <article className="w-full flex flex-col justify-center items-center">
        <img
          className=" rounded-full overflow-hidden w-[160px]  h-[160px]"
          src="https://nextjs-homework005.vercel.app/_next/image?url=https%3A%2F%2Fi.pinimg.com%2F736x%2F44%2F75%2Fbd%2F4475bde75fb129f2f65f00a494e2446b.jpg&w=256&q=75"
          alt="profile"
        />
        <h2 className="text-[24px] text-[#0B3954]">Nory Mengleang</h2>
        <p className="text-[20px] text-[#087E8B]">norymengleang@gmail.com</p>
      </article>
      <ul className=" flex flex-col gap-1 text-[20px] text-[#0B3954] px-[20px] py-[30px]">
        <Link href="/">
          <div
            className=" flex gap-2 items-center hover:font-bold hover:bg-[#f5f7f8] rounded-xl py-2 px-[30px]"
            style={{ backgroundColor: pathName == "/" ? "#e5eff7" : "" }}
          >
            <svg
              width="24"
              height="24"
        ...
        <Link href="/book-categories">
          <div
            className=" flex gap-2 items-center hover:font-bold hover:bg-[#f5f7f8] rounded-xl py-2 px-[30px]"
            style={{
              backgroundColor: pathName == "/book-categories" ? "#e5eff7" : "",
            }}
          >
            <svg
              width="24"
        ...
        <Link href="/old-school-cartoons">
          <div
            ...
            style={{
              backgroundColor:
                pathName == "/old-school-cartoons" ? "#e5eff7" : "",
            }}
          >
            <svg
              width="24"
            ...
            <li>Old-School Cartoons</li>
          </div>
        </Link>
        <div className=" flex gap-2 items-center hover:font-bold hover:bg-[#f5f7f8] rounded-xl py-2 px-[30px]">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      <button className=" flex gap-2 items-center text-[20px] text-[#0B3954] hover:font-bold bg-[#f5f7f8]  rounded-xl px-[30px] py-2 mx-[20px]">
        <svg
          width="25"
          height="24"
          viewBox="0 0 25 24"
